...
class ProfilesCommand(RESTCommand):
    ...
    def delete(self, profile_uuid, tenant_uuid=None):
    ...
    def edit(self, profile_uuid, body, tenant_uuid=None):
        headers = dict(self._rw_headers)
        tenant_uuid = tenant_uuid or self._client.tenant()
        if tenant_uuid:
            headers['Wazo-Tenant'] = tenant_uuid
    ...
    def get(self, profile_uuid, tenant_uuid=None):
        headers = dict(self._ro_headers)
        tenant_uuid = tenant_uuid or self._client.tenant()
        if tenant_uuid:
            headers['Wazo-Tenant'] = tenant_uuid
